...
SECRET_KEY = 'django-insecure-kgtc5p0ot-t2m03(c%d)sj^kkj7nrbw9pj()a(+dae_$ej1-t4'
...
ROOT_URLCONF = 'django_navie.urls'
...
WSGI_APPLICATION = 'django_navie.wsgi.application'
...
ASGI_APPLICATION = 'django_navie.routing.application'
...
# 'sss': django app name
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'django_navie', 'static'),
]
